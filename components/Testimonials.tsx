...
function Testimonials() {
  return (
    <div className=" lg:h-[70vh] bg-black/80 text-white py-10  flex flex-col sm:flex-row  px-3 md:px-10  xl:px-20 mt-10  ">
      <div className="flex-1 flex items-center justify-center ">
        <img
          className="w-1/2 xl:w-1/2 object-fill rounded-lg"
